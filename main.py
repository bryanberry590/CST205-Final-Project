...
from Image_Day import ImageFilterApp
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.image_page  = ImageFilterApp()
        ...
        self.stack.add_widget(self.image_page)
        ...
        self.main_page.go_to_image.connect(lambda: self._go(5))
        ...
        self.image_page.go_back.connect(lambda: self._go(0))
